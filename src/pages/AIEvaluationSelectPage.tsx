      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 py-8">
        <div className="mb-8">
          <div className="flex items-center gap-2 mb-2">
            ...
            <h1 className="text-xl font-bold text-slate-100 font-[Nunito_Sans]">Evaluar con IA</h1>
          </div>
          <p className="text-sm text-slate-400 font-[Nunito_Sans]">
            Seleccioná una oportunidad de <strong className="text-slate-200">{projectName}</strong> para que Claude la analice.
          </p>
        </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-16">
            <p className="text-sm text-slate-400 font-[Nunito_Sans]">No hay oportunidades para evaluar.</p>
          ...
          <div className="space-y-2">
            {active.map(opp => (
              <button
                ...
                className="w-full flex items-center gap-4 p-4 bg-slate-900 border border-slate-800 hover:border-violet-500/30 rounded-xl transition-all text-left group"
              >
                ...
                <div className="flex-1 min-w-0">
                  <p className="font-[Nunito_Sans] text-sm font-semibold text-slate-100 group-hover:text-violet-400 transition-colors truncate">
                    {opp.title}
                  </p>
